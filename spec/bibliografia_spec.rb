...
describe Bibliografias do
	  before(:each) do
	    ...
	    @b2 = Bibliografias::Bibliografia.new({:autor =>['Dave Thomas', 'Andy Hunt', 'Chad Fowler'],:titulo => 'Programming Ruby 1.9 & 2.0: ',:serie => 'The Facets of Ruby',:editorial => 'Pragmatic Bookshelf',:edicion => '4 edition',:fecha => 'July 7, 2013'})
...
Dennis', 'Aslak Hellesoy'],:titulo =>'The RSpec Book: Behaviour Driven Development with RSpec, Cucumber, and Friends',:serie => 'The Facets of Ruby',:editorial => 'Pragmatic Bookshelf',:edicion => '1 edition',:fecha => 'December 25, 2010'}),nil,nil) 
	  ...
	  describe 'Expectativas clase Lista de una Bibliografia' do
	    ...
	    describe 'Expectativas Clase Publicacion < Bibliografia ' do
		it ' Expectativa Debe existir una clase Publicacion < Bibliografia' do
